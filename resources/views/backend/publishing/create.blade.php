...
@section('header-content')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="card-title">Thêm mới Nhà sản xuất</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                    ...
                    <form role="form" method="POST" action="{{ route('backend.publishings.store') }}"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên Nhà sản xuất <span
                                        style="color: red"> *</span></label>
                                <input value="{{old('name')}}" type="text" class="form-control" id="" placeholder="Nhập tên Nhà sản xuất"
                                       name="name">
                                @error('name')
