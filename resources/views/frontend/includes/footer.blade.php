<footer id="footer" class="section section-grey">
    ...
    font-family: system-ui;margin-top: -20px">Houseware nhận đặt hàng trực tuyến và giao hàng tận nơi. KHÔNG hỗ trợ đặt mua và nhận hàng
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="footer">
                    ...
                    <ul class="list-links">
                        <li><a>housewareshop@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            <!-- /footer widget -->
